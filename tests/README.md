...
- `pepperstone-broker.test.js` - Tests Pepperstone cTrader CSV/XLSX closed-position formats
...
- `mock-pepperstone.csv` - Sample Pepperstone cTrader `Net AUD` closed-position data
